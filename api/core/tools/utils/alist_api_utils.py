...
class AListRequest:
    ...
    def _send_request(self, url: str, method: str = "post",
        ...
        res = httpx.request(method=method, url=url,
    ...
    def get_api_token(self, username: str, password: str) -> dict:
        ...
        Example Response:
        {
            ...
            "message": "success",
            "data": {
                "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwicHdkX3RzIjoxNzI0MjIyNTE0LCJleHAiOjE3MjU1MzU3NzMsIm5iZiI6MTcyNTM2Mjk3MywiaWF0IjoxNzI1MzYyOTczfQ.9OgFm0iUZwcj5M6jqPTCseg5rbmQZrnKq-jNleiN9bo"
            }
        }
        """
        payload = {
        ...
        res = self._send_request(api_url, require_token=False,
                                 payload=payload)
        return res
    ...
    def write_file(self, file_path: str, content: str) -> dict:
        ...
        res = self._send_request(api_url, content=content,
                                 method="put",
                                 headers=headers)
        return res
    ...
    def list_file(self, path: str, page: int = 1,

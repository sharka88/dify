...
class ToolNode(BaseNode):
    ...
    def _run(self, variable_pool: VariablePool) -> NodeRunResult:
        ...
        parameters = self._generate_parameters(
            tool_parameters=tool_parameters, variable_pool=variable_pool, node_data=node_data
        )
        parameters_for_log = self._generate_parameters(
            tool_parameters=tool_parameters, variable_pool=variable_pool, node_data=node_data, for_log=True
        )
